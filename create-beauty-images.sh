...
cat > static/images/hero-beauty-stylist.svg << 'EOF'
...
cat > static/images/icons/color.svg << 'svg'
<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 80 80">
  <circle cx="40" cy="40" r="38" fill="#f3e6d0" stroke="#d4af37" stroke-width="2"/>
...
cat > static/images/icons/brush.svg << 'svg'
<svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 80 80">
  <circle cx="40" cy="40" r="38" fill="#f3e6d0" stroke="#d4af37" stroke-width="2"/>
...
for i in {1..6}; do
  cat > "static/images/gallery/transformation-$i.jpg" << 'EOF'
<svg xmlns="http://www.w3.org/2000/svg" width="800" height="600" viewBox="0 0 800 600">
  <rect width="800" height="600" fill="#f9f5ee" />
